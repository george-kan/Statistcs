...
These are very reasonable questions to ask about our model of reality. And depending on the answer (which depends on the data we observe) we have to adapt our probability distribution accordingly. This could be done for example by adding extra parameters or modelling some days separately perhaps. 
